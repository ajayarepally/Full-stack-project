...
export default function Navbar() {
  ...
  // Update token if storage changes
  useEffect(() => {
    const update = () => {
      setToken(
        localStorage.getItem("access_token") ||
  ...
  // Calculate menu height for smooth transition
  useEffect(() => {
    if (menuRef.current) {
      setMenuHeight(menuRef.current.scrollHeight);
    }
    ...
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md p-4 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-indigo-700 text-lg">MAA Rentals</span>
        </Link>

        {/* Desktop Links */}
        <div className="hidden sm:flex items-center gap-6 text-gray-700">
          <Link to="/vehicles" className="hover:text-indigo-600">
            Search
          </Link>
          <HashLink smooth to="/#call-section" className="hover:text-indigo-600">
            Contact
          </HashLink>
          <HashLink smooth to="/#about" className="hover:text-indigo-600">
            About
          </HashLink>
      ...
      <div
        ...
        className="sm:hidden flex flex-col overflow-hidden transition-all duration-300 bg-white shadow-md"
      >
        <Link
          to="/vehicles"
        ...
        {token ? (
          <>
            ...
            <button
              ...
              className="m-4 bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700"
            >
              Logout
            </button>
          </>
