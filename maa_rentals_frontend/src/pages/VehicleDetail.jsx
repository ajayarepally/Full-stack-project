...
//   // Check availability dynamically whenever dates change
//   useEffect(() => {
...
//       .catch((err) => {
//         console.error(err);
//         setIsAvailable(vehicle?.is_available ?? true);
//       })
//       .finally(() => setLoading(false));
//   }, [startDate, endDate, id, vehicle]);
...
//     }
//     if (!isAvailable) {
//       setMessage("Vehicle is not available for selected dates.");
//       return;
//     }
...
//       .post(
//         "/bookings/",
//         { vehicle: id, start_date: startDate, end_date: endDate },
//         { headers: { Authorization: `Bearer ${token}` } }
//       )
//       .then((res) => setMessage("Booking successful!"))
//       .catch((err) => setMessage("Booking failed. Try again."));
//   };
...
//       <h2 className="text-2xl font-bold">{vehicle.brand} - {vehicle.title}</h2>
//       <img
...
//         }`}
//       >
//         {loading ? "Checking..." : isAvailable ? "Book Now" : "Not Available"}
//       </button>
