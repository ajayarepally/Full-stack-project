...
//   // Filter vehicles on search input
//   useEffect(() => {
...
//     fetchVehicles();
//     const interval = setInterval(fetchVehicles, 60 * 1000); // refresh every 1 min
...
//               <Link
//                 to={`/vehicles/${v.id}`}
//                 className={`mt-2 inline-block px-4 py-2 rounded ${v.is_active ? 'bg-indigo-600 text-white' : 'bg-gray-400 text-gray-200 cursor-not-allowed'}`}
//               >
